        ...
        <div className="bg-white py-8 px-6 shadow rounded-lg space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-md border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 disabled:opacity-50"
            >
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20" aria-label="GitHub">
                <title>GitHub</title>
                <path
                  fillRule="evenodd"
